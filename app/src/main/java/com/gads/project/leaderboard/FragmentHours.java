 ...
 * Use the {@link FragmentHours#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentHours extends Fragment {

    private static final String TAG = "FragmentHours";
    Retrofit retrofit;
     ...
     *
     * @return A new instance of fragment FragmentHours.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentHours newInstance() {
        FragmentHours fragment = new FragmentHours();
...
//        fragment.setArguments(args);
    ...
    private void getData() {
        Call<List<LearningHours>> listCall = hourAndSkillsApi.getHours();
        listCall.enqueue(new Callback<List<LearningHours>>() {
            @Override
